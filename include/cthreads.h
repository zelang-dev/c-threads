...
#define CTHREADS_VERSION_MAJOR 4
#define CTHREADS_VERSION_MINOR 2
#define CTHREADS_VERSION_PATCH 0
...
#ifndef _CTHREADS_EXTRA_H_
#define _CTHREADS_EXTRA_H_
